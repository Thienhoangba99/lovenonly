			...
			<div class="row" id="row-container">
			  ...
			  <div class="col-sm-3.5" id="header2">
			  	<div style="float: right;">
					<ul id="ul_logo">
						<li>
							<a href="http://localhost/thienhbgcd17084_source_code/App_shop/home.php" title="" class="li_logo">
								<span>
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						...
						<?php foreach ($categories as $key => $value){?>
							<li class="menu-item"><a href="by_category1.php?action=show_by_category&categoryid=<?php echo $value['categoryid']?>" title=""><?php echo $value['categoryname']; ?></a></li>
						<?php }?>
