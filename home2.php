			...
			<div class="row" id="row-container">
			  ...
			  <div class="col-sm-4" id="header2">
			  	<div style="float: right;">
					<ul id="ul_logo">
						<li>
							<a href="http://localhost/thienhbgcd17084_source_code/App_shop/Admin/controller/c_category.php" title="" class="li_logo">
								<span>
						...
						<li><a href="http://localhost/thienhbgcd17084_source_code/App_shop/Admin/controller/c_product.php" title="" class="li_logo">
						<span>
